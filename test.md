...
>![Репозиторий](image/NewFolder.png)  
...
>![Картинка Инициализации](image/GitInit.png)  
...
>![Состояние репозитария](image/GitStatus.png)  
...
>![Новый статус](image/NewStatus.png)  
...
>![Второй commit](image/SecondCommit.png)

Для того, просмотреть сохраненные версии вводим команду `git log`
>![список сохраненных версий](image/GitLog.png)  
...
>![Переход по версиям](image/FirstCheckout.png)
...
>![Текущие ветки](image/gitBranch.png)
...
>![Новая ветка](image/newBranch.png)
...
>![Наша вторая ветка](image/branch.png)
...
>![переход на ветку](image/checkoutNewbranch.png)
...
>![Текущая ситуация по веткам](image/lognew.png)
...
>![список коммитов](image/listcommit.png)
...
>![Слияние с веткой Мастер](image/FastForward.png)
...
>![Окно выбора](image/InfoConflict.png)
...
___
 ...
 >![Удаление веток](image/Delete.png)
...
>![Новая папака](image/RepoDir.png)
...
>![ссылка на репозиторий](image/LinkRepo.png)
...
>![клонируем репозитарий](image/Clone.png)
...
>![Отправляем информацию на удаленный репозиторий](image/Push.png)
...
>![Смотрим изменения на GitHub](image/SeePush.png)
...
>![Изменение файла](image/ChangeReadme.png)
...
>![Создание коммита](image/CreateCommit.png)
...
>![Выгрузка изменений](image/pull.png)
...
>![Копироване чужого репозитория](image/fork.png)
...
>![Создание Pull Request](image/PullRequest.png)
